...
```powershell
# Клонирование
git clone https://github.com/Artom2281/ProductionPractice.git
cd ProductionPractice
...
> Файл `library.db` добавлен в `.gitignore` - это локальная БД разработчика, она не должна попадать в репозиторий.

---

## Скриншоты

Интерфейс приложения на основных экранах:

| Экран | Описание |
|---|---|
| **Книги** | ![Книги](docs/screenshots/Книги.png) Каталог книг с фильтрацией и поиском |
| **Читатели** | ![Читатели](docs/screenshots/Читатели.png) Учёт зарегистрированных читателей |
| **Авторы** | ![Авторы](docs/screenshots/Авторы.png) Справочник авторов |
| **Жанры** | ![Жанры](docs/screenshots/Жанры.png) Управление жанровой систематикой |
| **Издательства** | ![Издательства](docs/screenshots/Издательства.png) Справочник издательств |
| **Выдачи и возвраты** | ![Выдачи и возвраты](docs/screenshots/ВыдачиИВозвраты.png) Учёт выданных книг и возвратов |
| **Отчёты** | ![Отчёты](docs/screenshots/Отчеты.png) Аналитические отчёты и графики |
